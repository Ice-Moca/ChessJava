...
public class PieceQueen extends Piece {
	...
	PieceQueen(PieceType pieceType, PlayerType playerType,Position pos) {
		super(Queen, playerType, pos);
	...
	public boolean moveAble(Board board, PlayerType playeType, Position Targetposition){
		...
		return this.DiagonalAble(board, playeType, Targetposition)||LineMoveAble(board, playeType, Targetposition);
	}
